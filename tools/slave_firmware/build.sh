...
# a host/slave version gap causes SDIO write failures. See that file's
# esp_hosted comment for the full version-history story (why not 2.12.3,
# why not 2.12.12). Check
